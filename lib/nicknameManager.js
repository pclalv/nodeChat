(function () {
  ...
  NicknameManager.getInstance = function () {
    if (!instance) instance = new NicknameManager();
    return instance;
  }
  ...
  NicknameManager.prototype.deleteNick = function (socket) {
    delete this.nicknames[socket.id];
  };

  module.exports = NicknameManager.getInstance();
})();
